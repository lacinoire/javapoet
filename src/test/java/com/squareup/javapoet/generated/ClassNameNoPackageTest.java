...
public final class ClassNameNoPackageTest {
    ...
    @Test public void shouldSupportClassInDefaultPackage() {
        ...
        assertThat(className.packageName()).isEqualTo("com.squareup.javapoet.generated");
        assertThat(className.simpleName()).isEqualTo("ClassNameNoPackageTest");
        assertThat(className.toString()).isEqualTo("com.squareup.javapoet.generated.ClassNameNoPackageTest");
    }

    /**
     * Amplified test case 'shouldSupportClassInDefaultPackage_2'
     *
    ...
    public void shouldSupportClassInDefaultPackage_2() throws Exception {
        List<AnnotationSpec> annotations = Collections.<AnnotationSpec>emptyList();
        ClassName className = ClassName.get(ClassNameNoPackageTest.class);
        ClassName className2 = className.annotated(annotations);
        Truth.assertThat(((ClassName) (className2)).isAnnotated()).isFalse();
    }
    ...
    /**
     * Amplified test case 'shouldSupportClassInDefaultPackage_excluded'
     *
