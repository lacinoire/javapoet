...
public class ParameterSpecTest {
    ...
    /**
     * Amplified test case 'modifyAnnotations_3'
     *
     * Input modifications: 0
    ...
    public void modifyAnnotations_3() throws Exception {
        ...
        AnnotationSpec annotationSpec = builder.annotations.remove(1);
        boolean booleanValue = annotationSpec.equals(object);
        Truth.assertThat(booleanValue).isFalse();
    }

    /**
     * Amplified test case 'modifyAnnotations_4'
     *
     * Input modifications: 1
     * Assert statements added: 1
     *
     * This test case improves the coverage in these classes/methods/lines:
    ...
    public void modifyAnnotations_4() throws Exception {
        ...
        Truth.assertThat(((ParameterSpec) (parameterSpec)).toString()).isEqualTo("@java.lang.Override int foo");
    }

    /**
     * Amplified test case 'modifyAnnotations_5'
     *
     * Input modifications: 1
     * Assert statements added: 1
     *
    ...
    public void modifyAnnotations_5() throws Exception {
        ParameterSpec.Builder builder = ParameterSpec.builder(int.class, "foo").addAnnotation(Override.class).addAnnotation(SuppressWarnings.class);
        AnnotationSpec annotationSpec = builder.annotations.remove(1);
        Truth.assertThat(((AnnotationSpec) (annotationSpec)).toString()).isEqualTo("@java.lang.SuppressWarnings");
    }
    ...
    /**
     * Amplified test case 'modifyAnnotations_excluded'
     *
     * Input modifications: 1
     * Assert statements added: 1
     *
     * This test
     * case improves the coverage in these classes/methods/lines:
     * com.squareup.javapoet.CodeBlock$Builder:
     * addArgument
     * L. 12 +7 instr.
     * L. 13 +1 instr.
     * argToType L. 1 +6 instr.
     * com.squareup.javapoet.CodeWriter$Multiset:
     * contains
     * L. 1 +11 instr.
     * com.squareup.javapoet.AnnotationSpec:
